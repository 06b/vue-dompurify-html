...
import type { DOMPurify, UponSanitizeElementHookEvent, UponSanitizeAttributeHookEvent, HookName } from 'dompurify';
...
export interface DirectiveConfig {
    ...
    hooks?: {
        ...
        [H in HookName | 'beforeSanitizeAttributes' | 'afterSanitizeAttributes']?: ((currentNode: Element, hookEvent: null, config: MinimalDOMPurifyConfig) => void) | undefined;
    } & {
